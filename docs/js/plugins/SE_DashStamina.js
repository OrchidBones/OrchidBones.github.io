...
║ Plugin Manager ║
╚════════════════╝
 * @plugindesc v2.05 Basic dashing stamina script.
...
Imported.SE_DashStamina = { name: 'SE_DashStamina', version: 2.05, author: 'Squirting Elephant', date:'2020-01-06'};
var SE = SE || {};
SE.Alias = SE.Alias || {};
SE.Params = SE.Params || {};
...
//#endregion
	...
	// returns true if there is a stamina window and if it's enabled by the parameter ShowStaminaWindow; otherwise returns false.
	Game_Player.prototype.hasStaminaWindow = function()
	{
		return (SE.DashStamina.ShowWindow === true) && (SE.DashStamina.Window !== null);
	}
